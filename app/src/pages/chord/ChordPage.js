		...
		if (this.state.actor === null) {
			return (
				<div>
					...
					<p className="CallToAction"><FontAwesomeIcon icon={faMouse} color="#fff" /> Hover on an actor to learn more about it</p>
					...
					<p>Then, the circle with the color represents its popularity and the number inside it the number of anime or movies the actor played in.</p>
				</div>
			)
		} else {
