      ...
      case null:
        return (
          <div className="StudiosExplanation">
            <h1>711</h1>
            <h2>Studios captivating the world</h2>
            <p style={{fontStyle: "italic"}}>Without them no anime could be aired and be given life, these studios producing a lot of them every year for everyone's happiness.</p>
